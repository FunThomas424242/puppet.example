...
class grundsystem inherits grundsystem::params {
	...
	$libsToInstall = ["network-manager-gnome","hplip-gui","librarian-puppet","puppet", "xbmc", "qasconfig" ,"libasound2-plugin-equal","alsa-base","software-properties-gtk", "aptitude"]
